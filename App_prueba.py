...
#### Lobby #### 
    ...
    if upload_dcm_1:
        ...
        if 'temp_png_valvs' not in st.session_state:
            ...
            _, paths_png_valvs  = carpetaPNG_paths(HV_valv[0] ,0)
            st.session_state.temp_png_valvs = paths_png_valvs 
...
#        temp_png_YOLOs = st.session_state.temp_png_YOLOs
        ...
        with tab1:
        	...
        	img_fnl_user_1 = Image.open(os.path.join(temp_png_valvs[N_org_1-1], f'slice_{(N_fnl_1+370):03d}.png'))
